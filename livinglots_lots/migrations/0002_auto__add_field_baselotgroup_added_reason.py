...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseLotGroup.added_reason'
        db.add_column(u'livinglots_lots_baselotgroup', 'added_reason',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseLotGroup.added_reason'
        db.delete_column(u'livinglots_lots_baselotgroup', 'added_reason')
